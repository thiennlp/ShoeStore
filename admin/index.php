...
//----------------------PHÂN TRANG------
$pp_product = 20; // Số sản phẩm hiển thị trên 1 trang
$pp_customer = 40; // Số khách hàng hiển thị trên 1 trang
...
<html lang="en">
    <head>
        ...
        <title>Admin - ZAC-JEAN 1.0</title>
...
//        if (isset($_SESSION['user'])) {
            ...
            <div id="wrapper">
                    ...
                    <div class="navbar-default sidebar" role="navigation">
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <!--<li>
                                    <a href="?page=sql"><i class="fa fa-file-text fa-fw"></i> Statement SQL</a>
                                </li>-->
                            </ul>
                        </div>
                        <!-- /.sidebar-collapse -->
                ...
                <div id="page-wrapper">
                    <?php
                    $array_page = array('category', 'product', 'user', 'customer', 'home', 'bill', 'object', 'size', 'banner', 'store', 'about', 'help', 'title', 'sql');
